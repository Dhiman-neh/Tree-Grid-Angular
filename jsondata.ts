...
export let sampleData = [
    {
        ...
        approved: false,
        subtasks: [
            { "task ID": 2, "task Name": 'Plan timeline', startDate: new Date('02/03/2017'),
                endDate: new Date('02/07/2017'), duration: 5, progress: 100, priority: 'Normal', approved: false },
            { "task ID": 3, "task Name": 'Plan budget', startDate: new Date('02/03/2017'),
                endDate: new Date('02/07/2017'), duration: 5, progress: 100, priority: 'Low', approved: true },
            { "task ID": 4, "task Name": 'Allocate resources', startDate: new Date('02/03/2017'),
                endDate: new Date('02/07/2017'), duration: 5, progress: 100, priority: 'Critical', approved: false },
            { "task ID": 5, "task Name": 'Planning complete', startDate: new Date('02/07/2017'),
